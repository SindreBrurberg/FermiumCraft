 ...
 */
public class RenderFabricator extends TileEntitySpecialRenderer {
    //The model of your block
    private final ModelFabricator model;

    public RenderFabricator() {
        this.model = new ModelFabricator();
    }
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {
        ...
        ResourceLocation textures = (new ResourceLocation(Reference.BlockFabricator));
