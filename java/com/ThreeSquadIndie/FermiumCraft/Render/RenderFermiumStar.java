...
/**
 * Created by Dethsanius on 09.05.2014, project is forge InteliJ package are com.ThreeSquadIndie.FermiumCraft.Render.
 */
public class RenderFermiumStar extends Render {
    @Override
    public void doRender(Entity var1, double var2, double var4, double var6, float var8, float var9) {
        GL11.glPushMatrix();
        GameRegistry.findItem(Reference.MODID, "Hard Fermium Star");
